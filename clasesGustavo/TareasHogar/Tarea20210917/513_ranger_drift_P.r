...
dtrain[ , c(campos_malos) := NULL ]  #elimino del dataset los campos malos
...
dapply[ , c(campos_malos) := NULL ]  #elimino del dataset los campos malos
...
#no utilizo las variales  mactivos_margen   mpasivos_margen
...
fwrite( entrega, 
        file="./kaggle/513_ranger_drift_P.csv", 
        sep="," )
