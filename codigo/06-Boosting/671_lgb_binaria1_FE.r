...
kscript           <- "671_lgb_binaria1_FE"
karch_generacion  <- "./datasets/paquete_premium_lag.csv.gz"
...
dataset  <- fread(karch_generacion)[(foto_mes>202006) & (foto_mes<=202011)]
...
dapply  <- fread(karch_generacion, stringsAsFactors= TRUE)[foto_mes==202101] #leo los datos donde voy a aplicar el modelo
